        ...
        <div style={{ padding: '2rem' }}>
            ...
            <div style={{ marginTop: '2rem', maxWidth: '600px', display: 'grid', gap: '1rem' }}>
                <div style={{ background: '#ffffff', padding: '1.5rem', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
                    ...
                    <p style={{ color: '#64748b', fontSize: '0.9rem', marginBottom: '1rem' }}>Update your personal information.</p>
                    <button style={{ padding: '0.5rem 1rem', background: '#3b82f6', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Edit Profile</button>
                </div>
